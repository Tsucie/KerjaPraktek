@extends('layouts.app', ['class' => 'bg-lighter'])
            ...
            <div class="col-lg-5 col-md-7">
                <div class="card bg-secondary shadow border-0">
                    <div class="card-header bg-transparent">
                        <div class="text-muted text-center mt-2 mb-2"><h1>{{ __('Login Admin') }}</h1></div>
                    </div>
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="text-left text-muted mb-4">
                            <small>Login dengan Email & Password yang terdaftar:</small>
                        </div>
                        <form role="form" method="POST" action="{{ route('login') }}" id="form-lgn">
                            @csrf
                            @if (session('errors'))
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary my-4" id="btn-lgn">{{ __('Login') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
