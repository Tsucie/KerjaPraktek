...
<head>
  ...
  <meta name="route" content="{{ __('http://127.0.0.1:8000') }}">
	<title>Venue Details - Silungkang Venue</title>
			...
			<div class="modal-dialog w700 modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-body pb-120">
						<button type="button" class="btn-close position-absolute top-0 start-100 translate-middle" data-bs-dismiss="modal" aria-label="Close">X</button>
						...
						<form method="POST" id="form-sewa">
							...
							<div class="modal-xs-pesan">
								...
								<div class="form-floating mb-3 col">
									<input class="form-control" id="input-sewa-namagedung-xs" type="text" aria-label="Disabled input example" value="{{ $data[0]->vnu_nama }}" disabled readonly />
									<label for="input-sewa-namagedung">Nama Gedung</label>
								</div>
								<div class="form-floating mb-3 col">
									<input class="form-control" id="input-sewa-keperluan" type="text" aria-label="Disabled input example" />
								...
								<label class="mb-1">Tanggal & Waktu Pemakaian</label>
								<div class="form-floating mb-3 col">
									<input type="date" class="form-control sewa" id="input-sewa-tanggal" placeholder="Name" required>
									<label for="input-sewa-tanggal">Tanggal</label>
								</div>
								<div class="form-floating mb-3 col">
									<select class="form-select" id="input-sewa-waktu" aria-label="Floating label select example">
				...
				<div class="modal-content">
					<div class="modal-body">
						...
						<form method="POST" id="form-feedback">
							<div class="row modal-md-feedback">
								<div class="form-floating mb-3 col">
							...
							<button class="thm-btn position-absolute bottom-0 end-0 feedback-btn-md" id="input-feedback-submit" type="submit">
								Kirim
							</button>
							<button class="thm-btn position-absolute bottom-0 start-50 translate-middle-x feedback-btn-xs" id="input-feedback-submit"
								type="submit">
								Kirim
							</button>
						</form>
				...
				<div class="container">
					<div class="pg-tp-wrp text-center">
						<div class="pg-tp-inr mt-5">
							<h1 itemprop="headline">GEDUNG</h1>
							<ol class="breadcrumb">
								<li class="breadcrumb-item">
									<a href="{{ route('welcome') }}" title="" itemprop="url">Home</a>
								</li>
								<li class="breadcrumb-item active">{{ $data[0]->vnu_nama }}</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="row pt-5">
							...
							<div class="col-md-5">
								...
								<div class="harga">
									...
									@else
										<span>Rp {{ number_format($data[0]->vnu_harga, 2) }}</span>
									@endif
								</div>
								<p>
									{{ $data[0]->vnu_desc }}
								...
								@if ($data[0]->vnu_status_tersedia == 1)
									<div class="btn-group-details">
										@auth('customer')
											<button type="button" class="thm-btn mb-2 btn-primary" data-bs-toggle="modal" data-bs-target="#feedback-modal" data-email="{{ $cs->cst_email }}" id="rvw-btn" style="width: 72%">
												Review Venue
											</button>
										@endauth
										<div class="">
											...
											<button class="thm-btn mb-2 shadow shadow-lg--hover btn-success" id="gedung_aula" type="submit" data-bs-toggle="modal" data-bs-target="#sewa-modal">
												Pesan
											</button>
										</div>
									</div>
														...
														<div class="explr-inf">
															...
															@else
																<ul>
																	...
																	@else
																		<li>Harga</li>
																		<li style="list-style: none">Rp {{ number_format($data[0]->vnu_harga, 2) }}</li>
																	@endif
																</ul>
															@endif
														</div>
												...
												<div class="row">
													<div class="col">
														<div class="explr-inf">
															...
															@else
																<ul>
																	<li>Jam 08:00 Pagi - 09:00 Malam</li>
																</ul>
															@endif
														</div>
													</div>
						...
						<div id="tgl1" class="tgl-styl style3 deskripsi-md">
							...
							<div class="tgl-itm">
								...
								<div class="tgl-cnt">
									<ul>
										<li>
											Biaya pemakaian Gedung dan biaya lain-lain harus dilunasi palng lambat 30
											(tiga puluh) hari
											sebelung tanggal pemakaian Gedung.
										</li>
										<li>DP (Down Payment) sewa Gedung minimal Rp. 2.000.000</li>
										<li>Pembatalan sewa Gedung 4 bulan sebelum acara, maka DP dikembalikan sebesar
											50%</li>
										<li>Pembatalan sewa Gedung 2 bulan sebelum acara, maka DP dikembalikan sebesar
											25%</li>
										<li>Pembatalan sewa Gedung kurang dari 2 bulan sebelum acara, maka DP Hangus
										</li>
										<li>
											Pembayaran sewa hanya melalui Rekening Mandiri a/n Perkumpulan Persatuan
											Keluarga Silungkang
										</li>
										<li>
											Kelebihan pemakaian sewa Gedung maksimal 2 jam akan dikenakan denda atau
											charge 50% dari biaya
											sewa Gedung
										</li>
									</ul>
								</div>
							...
							<div class="col-md-4 col-sm-12 col-xs-12 clearfix align-left mb-3">
								<div class="ce-feature-box-16 border margin-bottom">
									<div class="text-box text-center">
										<div class="imgbox-small round center overflow-hidden"><img src="http://via.placeholder.com/200x200" alt=""
												class="img-responsive" /></div>
										<div class="text-box">
											<h6 class="title less-mar-1 mt-1">Zikri</h6>
											<p class="subtext">Gedung Aula</p>
										</div>
										<br />
										<p class="content">Praesent mattis commodo augue Aliquam ornare hendrerit augue Cras tellus In pulvinar lectus a est.
										</p>
									</div>
								</div>
							</div>
								...
								<div class="ce-feature-box-16 border primary margin-bottom">
									<div class="text-box text-center">
										<div class="imgbox-small round center overflow-hidden"><img src="http://via.placeholder.com/200x200" alt=""
												class="img-responsive" /></div>
										<div class="text-box">
											<h6 class="title less-mar-1 mt-1">Rizki</h6>
											<p class="subtext">Gedung Aula</p>
										</div>
										<br />
										<p class="content">Praesent mattis commodo augue Aliquam ornare hendrerit augue Cras tellus In pulvinar lectus a est.
