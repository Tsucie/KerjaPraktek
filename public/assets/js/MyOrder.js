            ...
            '<div class="'+col+'card rounded shadow m-2">' +
              ...
              '<div class="p-4">' +
                ...
                '<ul style="list-style: none; padding-left: 1rem;">' +
                  ...
                  '<li><b>Biaya             : </b>Rp '+data.data[i].op_sum_biaya+'</li>' +
                  '<li><b>Status Order      : </b>' +
                    '<button class="btn btn-sm '+status.bg+' text-white rounded shadow" role="button">' + status.text + '</button>' +
                  '</li>' +
                '</ul>' +
        ...
        if (data.code == null) {
          ...
          modal.find('.modal-body').html(
            ...
            '<ul style="list-style: none; padding-left: 1rem;">' +
              ...
              '<li><b>Alamat    : </b><br><textarea style="background-color: #fff;width: 100%;height: 8rem;" disabled>'+data[0].op_alamat_pemesanan+'</textarea></li><hr class="dotted-hr">' +
              '<li><b>Tanggal Pesan : </b>'+data[0].op_tanggal_order+'</li><hr class="dotted-hr"><br>' +
              '<hr><li><h6>Detail Pemesanan Produk</h6></li><hr>' +
              '<li><b>Lokasi pengiriman produk dari: </b><br><textarea style="background-color: #fff;width: 100%;height: 8rem;" disabled>'+data[0].op_lokasi_pengiriman+'</textarea></li><hr class="dotted-hr">' +
              '<li><b>Produk dikirim ke: </b><br><textarea style="background-color: #fff;width: 100%;height: 8rem;" disabled>'+data[0].op_alamat_pengiriman+'</textarea></li><hr class="dotted-hr">' +
              ...
              '<li><b>Status Order : </b>' +
                '<button class="btn btn-sm '+status.bg+' text-white rounded" role="button">' + status.text + '</button>' +
              '</li><hr class="dotted-hr">' +
              (data[0].op_note_to_customer == null ? '' : '<li><b>Note : </b><br><textarea style="background-color: #fff;width: 100%;height: 8rem;" disabled>'+data[0].op_note_to_customer+'</textarea></li><hr class="dotted-hr">') +
            '</ul><br>'
          );
          modal.modal('show');
        }
