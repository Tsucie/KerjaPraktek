    ...
    $.fn.downCount = function (options, callback) {
        ...
        function countdown () {
            ...
            var ref_days = (days === 1) ? 'day' : 'days',
                ...
                ref_minutes = (min === 1) ? 'min' : 'min',
                ref_seconds = (sec === 1) ? 'sec' : 'sec';

            // set to DOM
            container.find('.days').text(days);
            container.find('.hours').text(hours);
            container.find('.minutes').text(min);
            container.find('.seconds').text(sec);
